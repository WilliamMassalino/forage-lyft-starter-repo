...
class CarFactory:
    ...
    @staticmethod
    def create_calliope(last_service_mileage, current_mileage, last_service_date):
        return Calliope(last_service_mileage, current_mileage, last_service_date)
    ...
    def create_glissade(last_service_mileage, current_mileage, last_service_date):
        return Glissade(last_service_mileage, current_mileage, last_service_date)
    ...
    def create_palindrome(last_service_mileage, current_mileage, last_service_date):
        return Palindrome(last_service_mileage, current_mileage, last_service_date)
    ...
    def create_rorschach(last_service_mileage, current_mileage, last_service_date):
        return Rorschach(last_service_mileage, current_mileage, last_service_date)
    ...
    def create_thovex(last_service_mileage, current_mileage, last_service_date):
        return Thovex(last_service_mileage, current_mileage, last_service_date)
